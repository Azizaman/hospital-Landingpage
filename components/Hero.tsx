  ...
  return (
    <div>
      ...
      >
        ...
        {/* Content */}
        <div className="container relative z-10 mx-auto px-4 py-32 min-h-screen flex flex-col items-center justify-center">
          <div className="max-w-5xl mx-auto text-center">
            {/* Heading */}
            <div className="relative flex flex-col items-center mb-6">
              {/* Icon Above Text */}
              <FaLeaf className="text-green-400 text-4xl mb-4 animate-pulse" />
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-green-400">
